<script>
    ...
    onMount(async () => {
      ...
      let d0 = await d3.csv("https://raw.githubusercontent.com/holtzy/D3-graph-gallery/master/DATA/data_doubleHist.csv")
      console.log(d0)
      // get the data
      ...
      var bins1 = histogram(d0.filter( function(d){return d.type === "variable 1"} ));
      var bins2 = histogram(d0.filter( function(d){return d.type === "variable 2"} ));
...
<div bind:this={el0} class="chart"></div>
